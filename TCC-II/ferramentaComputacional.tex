...
A imagem \ref{fig:modules} apresenta os modulos (bibliotecas) do sistema e a ligação entre eles e as imagens \ref{fig:Instances} e \ref{fig:Algorithms}
...
\caption{\label{fig:Instances}Classes que representam uma Instância e as soluções }
\end{figure}
...
\caption{\label{fig:Algorithms}Classes dos algoritmos das heurísticas de construção}
