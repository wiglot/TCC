...
\sloppy \item {CCPModel:} Representa o problema com todas estruturas básicas para representar uma instância a solução. Cuida também do enfileiramento dos pedidos de execução dos algoritmos e buscas locais.
\end{description}
