...
A escala de dificuldade de resolver do problema de agrupamento por
particionapodemento ser vista pela expressão de distintas partições $p$
existente em $n$ pontos,$N(n,p)$,
