...
Essa heurística tem como objetivo a construção rápida de uma solução, de forma gulosa,
...
sendo $T(a_{i},Y_{k})$ a função que devolve a soma das distâncias entre o ponto $a_{i}$ até todos os pontos de $Y_{k}$.
\begin{itemize}
