...
\subsection{J-Means}
Move o agrupamento para um nova mediana
Explicar e colocar os algoritmos.

\subsection{H-Means}
Move pontos para agrupamentos, depois escolhe os melhores centros. Desassocia os pontos dos agrupamento e associa para os centros mais próximospdf
