...
Ao designar um conjunto de OS a uma equipe, deve-se levar em consideração a  carga horária de cada mesma e a demanda de tempo que cada OS do conjunto de OS associado com a equipe.
