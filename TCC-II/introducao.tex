...
devemos associar todas OS as equipes de modo que uma OS seja atendida por uma, e não mais que uma, equipe.
...
Ao designar um conjunto de OS a uma equipe, deve-se levar em consideração a  carga horária de cada mesma e a demanda de tempo que cada OS do conjunto.
 Isso por si só pode ser visto como um Problema da Mochila, o que já não é um problema de solução trivial.
...
Um problema que engloba essas características apresentadas é o Problema de Agrupamento Capacitado (CCP - Capacitated Clustering Problem), clássico na literatura e também conhecido como Problema das P-Medianas Capacitado (CPMP).
...
existir uma folga entre das demandas e a capacidade. À frente neste trabalho será
