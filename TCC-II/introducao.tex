...
dispersos, necessitando um maior deslocamento das equipes de um atendimento a
...
capacidade de atendimento normalizadas para ser possível gerar soluções válidas
